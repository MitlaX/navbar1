...
const profilePicture = 'https://www.pngwing.com/es/free-png-zlrqq'
          ...
          <BlurView intensity={100}>
            <View style={styles.login}>
              ...
              <TouchableOpacity onPress={handleSignIn} style={[styles.button, {backgroundColor: '#00CFEB90'}]}>
                <Text style={{fontSize: 17, fontWeight: '400', color: 'white'}}>Inicia sesión</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={handleCreateAccount} style={[styles.button, {backgroundColor: '#6792F090'}]}>
                <Text style={{fontSize: 17, fontWeight: '400', color: 'white'}}>Crea cuenta</Text>
              </TouchableOpacity>
            </View>
          </BlurView>
        </ScrollView>
